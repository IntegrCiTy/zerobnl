ZerOBNL is a distributed co-simulation platform based on `ZeroMQ <http://zeromq.org/>`_, `Docker <https://www.docker.com/>`_ (Swarm and Compose) developped in `Python <https://www.python.org/>`_.
